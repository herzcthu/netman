...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">LogicalDevices</h1>
        <h1 class="pull-right form-inline">
            ...
            <a class="btn btn-primary" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('logicalDevices.create') !!}">Add New</a>
            {!! Form::close() !!}
        </h1>
    </section>
    <div class="content">
...
$(document).ready(function () {
    ...
    $('#generate').submit(function(e){
        ...
        $.ajax({
          method: "GET",
          url: "{!! route('logicaldevices.generate') !!}",
          xhrFields: {
